  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 flex flex-col h-screen sticky top-0">
      ...
      <div className="p-4 border-t border-slate-100 space-y-3">
        <Link
          href="/pricing"
          className="flex items-center gap-2 px-3 py-2 rounded-xl bg-linear-to-r from-rose-50 to-rose-50 border border-rose-100 hover:border-rose-300 transition-all"
        >
        ...
        <div className="flex items-center gap-3 px-2">
          <DropdownMenu.Root>
            <DropdownMenu.Trigger asChild>
              <button
                type="button"
                className="flex flex-1 items-center gap-3 min-w-0 rounded-2xl px-2 py-1.5 text-left hover:bg-slate-50 transition-colors cursor-pointer"
              >
            ...
            <DropdownMenu.Portal>
              ...
              >
                <DropdownMenu.Item
                  ...
                  className="cursor-pointer flex items-center gap-3 rounded-xl px-3 py-2 text-sm text-slate-700 outline-none transition-colors hover:bg-slate-50 hover:text-slate-900 focus:bg-slate-50 focus:text-slate-900"
                >
